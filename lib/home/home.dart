...
import 'package:tutorials/home/movie_service.dart';
import 'package:tutorials/home/movies_exception.dart';

import 'movie.dart';

final moviesFutureProvider = FutureProvider.autoDispose<List<Movie>>((ref) {
    ...
    return Scaffold(
      ...
      body: watch(moviesFutureProvider).when(
        ...
        error: (e, st) {
          ...
          return _ErrorBody(message: 'Oops, something went unexpected');
        },
      ),
    );
  }
